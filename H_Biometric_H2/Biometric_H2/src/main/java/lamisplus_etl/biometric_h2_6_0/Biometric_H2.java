...
package lamisplus_etl.biometric_h2_6_0;
...
/**
 * Job: Biometric_H2 Purpose: H_Biometric<br>
 * Description: H_Biometric <br>
 * @author ilozuechukwuemeka@yahoo.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Biometric_H2 implements TalendJob {
...
public String getLAMIS3_H2_Login(){
	...
	private final String jobName = "Biometric_H2";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Biometric_H2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class extract_biometricStruct implements routines.system.IPersistableRow<extract_biometricStruct> {
    final static byte[] commonByteArrayLock_LAMISPLUS_ETL_Biometric_H2 = new byte[0];
    static byte[] commonByteArray_LAMISPLUS_ETL_Biometric_H2 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMISPLUS_ETL_Biometric_H2.length) {
				if(length < 1024 && commonByteArray_LAMISPLUS_ETL_Biometric_H2.length == 0) {
   					commonByteArray_LAMISPLUS_ETL_Biometric_H2 = new byte[1024];
				} else {
   					commonByteArray_LAMISPLUS_ETL_Biometric_H2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMISPLUS_ETL_Biometric_H2, 0, length);
			strReturn = new String(commonByteArray_LAMISPLUS_ETL_Biometric_H2, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_Biometric_H2) {
...
int count_tDBOutput_1=0;
	    ...
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id\",\"person_uuid\",\"facility_id\",\"template_type\",\"biometric_type\",\"enrollment_date\",\"created_date\",\"last_modified_date\",\"template\",\"archived\",\"iso\",\"created_by\",\"last_modified_by\",\"device_name\",\"version_iso_20\",\"" + "extra" + "\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?," + "?::json" + ")";
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"id\" = ?,\"person_uuid\" = ?,\"facility_id\" = ?,\"template_type\" = ?,\"biometric_type\" = ?,\"enrollment_date\" = ?,\"created_date\" = ?,\"last_modified_date\" = ?,\"template\" = ?,\"archived\" = ?,\"iso\" = ?,\"created_by\" = ?,\"last_modified_by\" = ?,\"device_name\" = ?,\"version_iso_20\" = ?,\"" + "extra" + "\" = " + "?::json" + " WHERE \"id\" = ?";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT b.biometric_id AS id, b.patient_id as person_uuid, b.facility_id, \n(CASE WHEN template_type='RIGHT_THUMB' THEN "
+"'Right Thumb'\nWHEN template_type='RIGHT_RING_FINGER' THEN 'Right Middle Finger'\nWHEN template_type='RIGHT_MIDDLE_FINGE"
+"R' THEN 'Right Index Finger'\nWHEN template_type='RIGHT_LITTLE_FINGER' THEN 'Right Little Finger'\nWHEN template_type='R"
+"IGHT_INDEX_FINGER' THEN 'Right Index Finger'\nWHEN template_type='LEFT_THUMB' THEN 'Left Thumb'\nWHEN template_type='LEF"
+"T_RING_FINGER' THEN 'Left Ring Finger'\nWHEN template_type='LEFT_MIDDLE_FINGER' THEN 'Left Middle Finger'\nWHEN template"
+"_type='LEFT_LITTLE_FINGER' THEN 'Left Little Finger'\nWHEN template_type='LEFT_INDEX_FINGER' THEN 'Left Index Finger'\nE"
+"LSE template_type\nEND) AS template_type, \n'Secugen' AS device_name,\nbiometric_type, enrollment_date, b.time_stamp AS "
+"last_modified, \ntemplate, 0 AS archived, TRUE AS iso, f.datim_id, TRUE AS version_iso_20,\njson_build_object('is_valid'"
+", b.is_valid) AS extra\n	FROM biometric b\n	INNER JOIN facility f\n  ON f.facility_id=b.facility_id\nINNER JOIN patient "
+"p ON p.id_uuid=b.patient_id";
            ...
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tDBInput_1 < 14) {
								biometric_record.extra = null;
							} else {
	                         		
        	biometric_record.extra = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
		                    }
...
extract_biometric_tmp.extra = biometric_record.extra ;
...
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
                        ...
                        pstmtUpdate_tDBOutput_1.setLong(3, extract_biometric.facility_id);
...
pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.ARRAY);
                        ...
                        pstmtUpdate_tDBOutput_1.setInt(10, extract_biometric.archived);

                        pstmtUpdate_tDBOutput_1.setBoolean(11, extract_biometric.iso);
...
pstmtUpdate_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
                        ...
                        if(extract_biometric.extra == null) {
pstmtUpdate_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(16, extract_biometric.extra);
}

                        if(extract_biometric.id == null) {
pstmtUpdate_tDBOutput_1.setNull(17 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(17 + count_tDBOutput_1, extract_biometric.id);
}
...
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
                        ...
                        pstmtInsert_tDBOutput_1.setLong(3, extract_biometric.facility_id);
...
pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.ARRAY);
                        ...
                        pstmtInsert_tDBOutput_1.setInt(10, extract_biometric.archived);

                        pstmtInsert_tDBOutput_1.setBoolean(11, extract_biometric.iso);
...
} else {pstmtInsert_tDBOutput_1.setString(16, extract_biometric.extra);
}
...
System.out.println("*************H2 BIOMETRIC(SECUGEN) MIGRATION REPORT END*****************");
System.out.println("****************************************************************");
...
System.out.println("*****************************************************************");
System.out.println("***********H2 BIOMETRIC(SECUGEN) MIGRATION REPORT START*****************");
 ...
 */
    ...
    public static void main(String[] args){
        final Biometric_H2 Biometric_H2Class = new Biometric_H2();

        int exitCode = Biometric_H2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Biometric_H2.class.getClassLoader().getResourceAsStream("lamisplus_etl/biometric_h2_6_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Biometric_H2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Biometric_H2");
        }
...
/************************************************************************************************
 *     129823 characters generated by Talend Open Studio for Big Data 
 *     on the March 22, 2023 12:23:41 PM WAT
 ************************************************************************************************/