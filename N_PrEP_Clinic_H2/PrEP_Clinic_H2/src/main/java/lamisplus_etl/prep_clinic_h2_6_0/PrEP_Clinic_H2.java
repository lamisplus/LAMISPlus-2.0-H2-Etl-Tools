...
package lamisplus_etl.prep_clinic_h2_6_0;
...
/**
 * Job: PrEP_Clinic_H2 Purpose: PrEP_Clinic<br>
 * Description: PrEP_Clinic <br>
 * @author ilozuechukwuemeka@yahoo.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class PrEP_Clinic_H2 implements TalendJob {
...
public String getLAMISPlus_Database(){
	...
	private final String jobName = "PrEP_Clinic_H2";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				PrEP_Clinic_H2.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(PrEP_Clinic_H2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class prep_clinic_stage_outStruct implements routines.system.IPersistableRow<prep_clinic_stage_outStruct> {
    final static byte[] commonByteArrayLock_LAMISPLUS_ETL_PrEP_Clinic_H2 = new byte[0];
    static byte[] commonByteArray_LAMISPLUS_ETL_PrEP_Clinic_H2 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMISPLUS_ETL_PrEP_Clinic_H2.length) {
				if(length < 1024 && commonByteArray_LAMISPLUS_ETL_PrEP_Clinic_H2.length == 0) {
   					commonByteArray_LAMISPLUS_ETL_PrEP_Clinic_H2 = new byte[1024];
				} else {
   					commonByteArray_LAMISPLUS_ETL_PrEP_Clinic_H2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMISPLUS_ETL_PrEP_Clinic_H2, 0, length);
			strReturn = new String(commonByteArray_LAMISPLUS_ETL_PrEP_Clinic_H2, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_PrEP_Clinic_H2) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_6 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_6 = "SELECT pp.hospital_num, \n	pf.date_visit::timestamp as encounter_date, \n	pf.date_visit::timestamp AS date_prep_given,"
+"\n	pp.time_stamp as date_created, \n	pp.time_stamp as date_modified,\n	'ETL' AS created_by,\n	'ETL' AS modified_by, NULL "
+"AS extra,\n	CONCAT(pp.prep_id, n.datim_id, pp.prep_id)::VARCHAR as uuid,\n    0::integer AS archived, \n	NULL AS body_we"
+"ight, \n	NULL as systolic,\n   	NULL as diastolic, \n	  NULL AS height,\n	  (CASE WHEN com.max_date IS NOT NULL AND pf.a"
+"rv_dispensed ILIKE '%mg%' THEN TRUE\n	  ELSE FALSE END )AS is_commencement,\n  CAST(pf.date_visit + pf.duration AS DATE)"
+" AS next_appointment,\n  pf.arv_dispensed AS description,\n  NULL AS adherence_level,\n  (CASE WHEN pf.hiv_test_result='"
+"HIV Negative' THEN 'neg'\n  WHEN pf.hiv_test_result='HIV Positive' THEN 'pos'\n  ELSE NULL END)AS hiv_test_result,\n  CA"
+"ST(pf.duration AS INTEGER) as duration,\n  (CASE WHEN pp.pregnancy_status IS NULL THEN NULL\n  WHEN pp.pregnancy_status="
+"1 THEN 'PREGANACY_STATUS_PREGNANT'\n  ELSE 'PREGANACY_STATUS_NOT_PREGNANT'\n  END) pregnant,\n    n.datim_id AS datim_id"
+"\n    FROM prepfollowup pf \n	INNER JOIN prep pp ON pp.prep_id = pf.prep_id\n    LEFT JOIN prepscreening p ON p.client_u"
+"nique_id=pp.hospital_num\n	LEFT JOIN (SELECT MAX(date_prep_initiation)max_date, prepscreening_id FROM prep \n			   WHERE"
+" prescribed_arv IS NOT NULL GROUP BY prepscreening_id) com ON com.prepscreening_id=pp.prepscreening_id\n	INNER JOIN faci"
+"lity n \n    ON n.facility_id=pf.facility_id\nORDER BY pf.prepfollowup_id ASC";
		    ...
		    while (rs_tDBInput_6.next()) {
		        nb_line_tDBInput_6++;
							...
							if(colQtyInRs_tDBInput_6 < 1) {
								row3.hospital_num = null;
							} else {
	                         		
        	row3.hospital_num = routines.system.JDBCUtil.getString(rs_tDBInput_6, 1, false);
		                    }
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		    ...
                        		    		    row4HashKey.hospital_number = row3.hospital_num ;
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.hospital_number = '" + row4HashKey.hospital_number + "'");
								} // G 071
...
prep_clinic_stage_out_tmp.person_uuid = row4.uuid;
...
public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.hospital_number == null) ? 0 : this.hospital_number.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row4Struct other = (row4Struct) obj;
						...
						if (this.hospital_number == null) {
							if (other.hospital_number != null)
								return false;
						
						} else if (!this.hospital_number.equals(other.hospital_number))
    ...
    public int compareTo(row4Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.hospital_number, other.hospital_number);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// source node:tDBInput_10 - inputs:(after_tDBInput_6) outputs:(row4,row4) | target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
			   		// linked node: tMap_3 - inputs:(row3,row4) outputs:(prep_clinic_stage_out)
 ...
 */
	...
	final String decryptedPassword_tDBInput_10 = context.LAMISPlus_Password; 
		    ...
		    String dbquery_tDBInput_10 = "SELECT uuid, hospital_number FROM patient_person";
        	...
        	row4.uuid = routines.system.JDBCUtil.getString(rs_tDBInput_10, 1, false);
		                    }
							if(colQtyInRs_tDBInput_10 < 2) {
								row4.hospital_number = null;
							} else {
	                         		
        	row4.hospital_number = routines.system.JDBCUtil.getString(rs_tDBInput_10, 2, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
				...
				row4_HashRow.uuid = row4.uuid;
				
				row4_HashRow.hospital_number = row4.hospital_number;
 ...
 */
    ...
    public static void main(String[] args){
        final PrEP_Clinic_H2 PrEP_Clinic_H2Class = new PrEP_Clinic_H2();

        int exitCode = PrEP_Clinic_H2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = PrEP_Clinic_H2.class.getClassLoader().getResourceAsStream("lamisplus_etl/prep_clinic_h2_6_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = PrEP_Clinic_H2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : PrEP_Clinic_H2");
        }
...
/************************************************************************************************
 *     358811 characters generated by Talend Open Studio for Big Data 
 *     on the April 29, 2023 6:26:13 AM WAT
 ************************************************************************************************/