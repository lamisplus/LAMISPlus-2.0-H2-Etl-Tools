...
package lamisplus_etl.hiv_status_tracker_h2_6_0;
...
/**
 * Job: HIV_Status_Tracker_H2 Purpose: HIV_Status_Tracker<br>
 * Description: HIV_Status_Tracker <br>
 * @author ilozuechukwuemeka@yahoo.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class HIV_Status_Tracker_H2 implements TalendJob {
...
public String getLAMIS3_H2_Login(){
	...
	private final String jobName = "HIV_Status_Tracker_H2";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				HIV_Status_Tracker_H2.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HIV_Status_Tracker_H2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_LAMISPLUS_ETL_HIV_Status_Tracker_H2 = new byte[0];
    static byte[] commonByteArray_LAMISPLUS_ETL_HIV_Status_Tracker_H2 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMISPLUS_ETL_HIV_Status_Tracker_H2.length) {
				if(length < 1024 && commonByteArray_LAMISPLUS_ETL_HIV_Status_Tracker_H2.length == 0) {
   					commonByteArray_LAMISPLUS_ETL_HIV_Status_Tracker_H2 = new byte[1024];
				} else {
   					commonByteArray_LAMISPLUS_ETL_HIV_Status_Tracker_H2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMISPLUS_ETL_HIV_Status_Tracker_H2, 0, length);
			strReturn = new String(commonByteArray_LAMISPLUS_ETL_HIV_Status_Tracker_H2, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_HIV_Status_Tracker_H2) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT sh1.history_id AS id, sh1.time_stamp AS created_date, 'ETL' as created_by, \nsh1.time_stamp as last_modified_dat"
+"e,'ETL' as last_modified_by,\np.id_uuid as person_id, sh1.current_status as hiv_status, sh1.date_current_status as statu"
+"s_date,\nsh1.outcome as tracking_outcome, sh1.date_tracked as track_date, sh1.agreed_date,\nsh1.reason_interrupt AS reas"
+"on_for_interruption, sh1.cause_death AS cause_of_death, FALSE AS auto,\nCONCAT(sh1.history_id, '-',nf.datim_id, '-',sh1."
+"history_id) AS uuid,\n0 AS archived, nf.datim_id\nFROM statushistory sh1\nINNER JOIN patient p ON sh1.patient_id = p.pat"
+"ient_id\nINNER JOIN facility nf ON sh1.facility_id = nf.facility_id\nORDER BY sh1.patient_id ASC";
 ...
 */
    ...
    public static void main(String[] args){
        final HIV_Status_Tracker_H2 HIV_Status_Tracker_H2Class = new HIV_Status_Tracker_H2();

        int exitCode = HIV_Status_Tracker_H2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HIV_Status_Tracker_H2.class.getClassLoader().getResourceAsStream("lamisplus_etl/hiv_status_tracker_h2_6_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HIV_Status_Tracker_H2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HIV_Status_Tracker_H2");
        }
...
/************************************************************************************************
 *     178912 characters generated by Talend Open Studio for Big Data 
 *     on the March 22, 2023 12:25:13 PM WAT
 ************************************************************************************************/