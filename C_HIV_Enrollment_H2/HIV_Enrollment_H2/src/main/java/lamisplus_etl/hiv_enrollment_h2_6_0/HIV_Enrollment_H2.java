...
package lamisplus_etl.hiv_enrollment_h2_6_0;
 ...
 * @status 
 */
public class HIV_Enrollment_H2 implements TalendJob {
...
public String getLAMIS3_H2_Login(){
	...
	private final String jobName = "HIV_Enrollment_H2";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				HIV_Enrollment_H2.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HIV_Enrollment_H2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_LAMISPLUS_ETL_HIV_Enrollment_H2 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMISPLUS_ETL_HIV_Enrollment_H2.length) {
				if(length < 1024 && commonByteArray_LAMISPLUS_ETL_HIV_Enrollment_H2.length == 0) {
   					commonByteArray_LAMISPLUS_ETL_HIV_Enrollment_H2 = new byte[1024];
				} else {
   					commonByteArray_LAMISPLUS_ETL_HIV_Enrollment_H2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMISPLUS_ETL_HIV_Enrollment_H2, 0, length);
			strReturn = new String(commonByteArray_LAMISPLUS_ETL_HIV_Enrollment_H2, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_HIV_Enrollment_H2) {
...
copyOfCreate_HIV_JSONString_tmp.person_uuid = row2.person_uuid ;
...
copyOfCreate_HIV_JSONString_tmp.uuid = row2.uuid;
...
} else {pstmtUpdate_tDBOutput_3.setLong(29 + count_tDBOutput_3, row1.id);
}
...
} else {pstmtInsert_tDBOutput_3.setLong(1, row1.id);
}
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = context.LAMISPlus_Password; 
		    ...
		    String dbquery_tDBInput_3 = "SELECT DISTINCT c.id,codeset_group,LOWER(LEFT(display, 8)) AS display FROM public.base_application_codeset c\nINNER JOI"
+"N etl_hiv_enrollment_stage h\n  ON c.display = h.enrollment_setting_id WHERE c.codeset_group='ENROLLMENT_SETTING'";
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = context.LAMISPlus_Password; 
		    ...
		    String dbquery_tDBInput_4 = "SELECT person_uuid, LOWER(LEFT(enrollment_setting_id, 8)) AS enrollment_setting_id\nFROM etl_hiv_enrollment_stage";
	...
	currentComponent="tDBInput_18";
		...
		int tos_count_tDBInput_18 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_18 = null;
				...
				String dbUser_tDBInput_18 = context.LAMIS3_H2_Login;
				
				
	final String decryptedPassword_tDBInput_18 = context.LAMIS3_H2_Password; 
				
				String dbPwd_tDBInput_18 = decryptedPassword_tDBInput_18;
				
				String url_tDBInput_18 = "jdbc:postgresql://" + context.LAMIS3_H2_Server + ":" + context.LAMIS3_H2_Port + "/" + context.LAMIS3_H2_Database + "?" + context.LAMIS3_H2_AdditionalParams;
		    ...
		    String dbquery_tDBInput_18 = "SELECT  p.id_uuid as person_uuid,\nNULL as referred_to_ovcpartner,\no.date_enrolled_ovc as date_referred_to_ovcpartner,"
+"\nNULL as date_referred_from_ovcpartner,\no.ovc_household_number as house_hold_number\nFROM patient p\nINNER JOIN ovc o "
 ...
 */
    ...
    public static void main(String[] args){
        final HIV_Enrollment_H2 HIV_Enrollment_H2Class = new HIV_Enrollment_H2();

        int exitCode = HIV_Enrollment_H2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HIV_Enrollment_H2.class.getClassLoader().getResourceAsStream("lamisplus_etl/hiv_enrollment_h2_6_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HIV_Enrollment_H2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HIV_Enrollment_H2");
        }
