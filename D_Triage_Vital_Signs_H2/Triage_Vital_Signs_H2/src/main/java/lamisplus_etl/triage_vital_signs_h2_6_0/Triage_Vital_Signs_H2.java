...
package lamisplus_etl.triage_vital_signs_h2_6_0;
 ...
 * @status 
 */
public class Triage_Vital_Signs_H2 implements TalendJob {
...
public String getLAMIS3_H2_Login(){
	...
	private final String jobName = "Triage_Vital_Signs_H2";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Triage_Vital_Signs_H2.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Triage_Vital_Signs_H2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class extractStruct implements routines.system.IPersistableRow<extractStruct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMISPLUS_ETL_Triage_Vital_Signs_H2.length) {
				if(length < 1024 && commonByteArray_LAMISPLUS_ETL_Triage_Vital_Signs_H2.length == 0) {
   					commonByteArray_LAMISPLUS_ETL_Triage_Vital_Signs_H2 = new byte[1024];
				} else {
   					commonByteArray_LAMISPLUS_ETL_Triage_Vital_Signs_H2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMISPLUS_ETL_Triage_Vital_Signs_H2, 0, length);
			strReturn = new String(commonByteArray_LAMISPLUS_ETL_Triage_Vital_Signs_H2, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_Triage_Vital_Signs_H2) {
...
int count_tDBOutput_1=0;
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"person_uuid\" VARCHAR(100)  ,\"facility_id\" INT8  not null ,\"created_date\" TIMESTAMP(29)  ,\"last_modified_date\" TIMESTAMP(29)  ,\"uuid\" VARCHAR(100)  ,\"archived\" INT4 ,\"body_weight\" FLOAT8 ,\"diastolic\" FLOAT8 ,\"systolic\" FLOAT8 ,\"height\" FLOAT8 ,\"datim_id\" VARCHAR(32)   not null ,\"visit_id\" VARCHAR(100)   not null ,\"id\" INT4  not null ,\"capture_date\" TIMESTAMP(29)  ,primary key(\"id\"))");
                                    }
                                }
...
for(int i_tSortRow_3_SortIn = 0; i_tSortRow_3_SortIn < array_tSortRow_3_SortIn.length; i_tSortRow_3_SortIn++){
	...
	row1.id = current_tSortRow_3_SortIn.id;
	row1.person_uuid = current_tSortRow_3_SortIn.person_uuid;
	row1.facility_id = current_tSortRow_3_SortIn.facility_id;
	row1.created_date = current_tSortRow_3_SortIn.created_date;
	row1.last_modified_date = current_tSortRow_3_SortIn.last_modified_date;
	row1.created_by = current_tSortRow_3_SortIn.created_by;
	row1.last_modified_by = current_tSortRow_3_SortIn.last_modified_by;
	row1.uuid = current_tSortRow_3_SortIn.uuid;
	row1.visit_id = current_tSortRow_3_SortIn.visit_id;
	row1.archived = current_tSortRow_3_SortIn.archived;
	row1.body_weight = current_tSortRow_3_SortIn.body_weight;
	row1.diastolic = current_tSortRow_3_SortIn.diastolic;
	row1.systolic = current_tSortRow_3_SortIn.systolic;
	row1.height = current_tSortRow_3_SortIn.height;
	row1.temperature = current_tSortRow_3_SortIn.temperature;
	row1.pulse = current_tSortRow_3_SortIn.pulse;
	row1.respiratory_rate = current_tSortRow_3_SortIn.respiratory_rate;
	row1.capture_date = current_tSortRow_3_SortIn.capture_date;
...
} else {pstmt_tDBOutput_5.setLong(1, row1.id);
}
...
} else {pstmtUpdate_tDBOutput_5.setLong(1, row1.id);
}

                        if(row1.person_uuid == null) {
pstmtUpdate_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_5.setString(2, row1.person_uuid);
}

                        if(row1.facility_id == null) {
pstmtUpdate_tDBOutput_5.setNull(3, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_5.setLong(3, row1.facility_id);
}

                        if(row1.created_date != null) {
pstmtUpdate_tDBOutput_5.setTimestamp(4, new java.sql.Timestamp(row1.created_date.getTime()));
} else {
pstmtUpdate_tDBOutput_5.setNull(4, java.sql.Types.TIMESTAMP);
}

                        if(row1.last_modified_date != null) {
pstmtUpdate_tDBOutput_5.setTimestamp(5, new java.sql.Timestamp(row1.last_modified_date.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_5.setString(6, row1.created_by);
}

                        if(row1.last_modified_by == null) {
pstmtUpdate_tDBOutput_5.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_5.setString(7, row1.last_modified_by);
}

                        if(row1.uuid == null) {
pstmtUpdate_tDBOutput_5.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_5.setString(8, row1.uuid);
}

                        if(row1.visit_id == null) {
pstmtUpdate_tDBOutput_5.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_5.setString(9, row1.visit_id);
}

                        pstmtUpdate_tDBOutput_5.setInt(10, row1.archived);

                        if(row1.body_weight == null) {
pstmtUpdate_tDBOutput_5.setNull(11, java.sql.Types.DOUBLE);
} else {pstmtUpdate_tDBOutput_5.setDouble(11, row1.body_weight);
}

                        if(row1.diastolic == null) {
pstmtUpdate_tDBOutput_5.setNull(12, java.sql.Types.DOUBLE);
} else {pstmtUpdate_tDBOutput_5.setDouble(12, row1.diastolic);
}

                        if(row1.systolic == null) {
pstmtUpdate_tDBOutput_5.setNull(13, java.sql.Types.DOUBLE);
} else {pstmtUpdate_tDBOutput_5.setDouble(13, row1.systolic);
}

                        if(row1.height == null) {
pstmtUpdate_tDBOutput_5.setNull(14, java.sql.Types.DOUBLE);
} else {pstmtUpdate_tDBOutput_5.setDouble(14, row1.height);
}

                        if(row1.temperature == null) {
pstmtUpdate_tDBOutput_5.setNull(15, java.sql.Types.DOUBLE);
} else {pstmtUpdate_tDBOutput_5.setDouble(15, row1.temperature);
}

                        if(row1.pulse == null) {
pstmtUpdate_tDBOutput_5.setNull(16, java.sql.Types.DOUBLE);
} else {pstmtUpdate_tDBOutput_5.setDouble(16, row1.pulse);
}

                        if(row1.respiratory_rate == null) {
pstmtUpdate_tDBOutput_5.setNull(17, java.sql.Types.DOUBLE);
} else {pstmtUpdate_tDBOutput_5.setDouble(17, row1.respiratory_rate);
}

                        if(row1.capture_date != null) {
pstmtUpdate_tDBOutput_5.setTimestamp(18, new java.sql.Timestamp(row1.capture_date.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_5.setLong(19 + count_tDBOutput_5, row1.id);
}
...
} else {pstmtInsert_tDBOutput_5.setLong(1, row1.id);
}

                        if(row1.person_uuid == null) {
pstmtInsert_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_5.setString(2, row1.person_uuid);
}

                        if(row1.facility_id == null) {
pstmtInsert_tDBOutput_5.setNull(3, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_5.setLong(3, row1.facility_id);
}

                        if(row1.created_date != null) {
pstmtInsert_tDBOutput_5.setTimestamp(4, new java.sql.Timestamp(row1.created_date.getTime()));
} else {
pstmtInsert_tDBOutput_5.setNull(4, java.sql.Types.TIMESTAMP);
}

                        if(row1.last_modified_date != null) {
pstmtInsert_tDBOutput_5.setTimestamp(5, new java.sql.Timestamp(row1.last_modified_date.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_5.setString(6, row1.created_by);
}

                        if(row1.last_modified_by == null) {
pstmtInsert_tDBOutput_5.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_5.setString(7, row1.last_modified_by);
}

                        if(row1.uuid == null) {
pstmtInsert_tDBOutput_5.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_5.setString(8, row1.uuid);
}

                        if(row1.visit_id == null) {
pstmtInsert_tDBOutput_5.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_5.setString(9, row1.visit_id);
}

                        pstmtInsert_tDBOutput_5.setInt(10, row1.archived);

                        if(row1.body_weight == null) {
pstmtInsert_tDBOutput_5.setNull(11, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_5.setDouble(11, row1.body_weight);
}

                        if(row1.diastolic == null) {
pstmtInsert_tDBOutput_5.setNull(12, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_5.setDouble(12, row1.diastolic);
}

                        if(row1.systolic == null) {
pstmtInsert_tDBOutput_5.setNull(13, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_5.setDouble(13, row1.systolic);
}

                        if(row1.height == null) {
pstmtInsert_tDBOutput_5.setNull(14, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_5.setDouble(14, row1.height);
}

                        if(row1.temperature == null) {
pstmtInsert_tDBOutput_5.setNull(15, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_5.setDouble(15, row1.temperature);
}

                        if(row1.pulse == null) {
pstmtInsert_tDBOutput_5.setNull(16, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_5.setDouble(16, row1.pulse);
}

                        if(row1.respiratory_rate == null) {
pstmtInsert_tDBOutput_5.setNull(17, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_5.setDouble(17, row1.respiratory_rate);
}

                        if(row1.capture_date != null) {
pstmtInsert_tDBOutput_5.setTimestamp(18, new java.sql.Timestamp(row1.capture_date.getTime()));
} else {
...
System.out.println("Total updated records migrated - "+globalMap.get("tDBOutput_5_NB_LINE_UPDATED"));
 ...
 */
    ...
    public static void main(String[] args){
        final Triage_Vital_Signs_H2 Triage_Vital_Signs_H2Class = new Triage_Vital_Signs_H2();

        int exitCode = Triage_Vital_Signs_H2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Triage_Vital_Signs_H2.class.getClassLoader().getResourceAsStream("lamisplus_etl/triage_vital_signs_h2_6_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Triage_Vital_Signs_H2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Triage_Vital_Signs_H2");
        }
...
/************************************************************************************************
 *     293255 characters generated by Talend Open Studio for Big Data 
 *     on the March 23, 2023 3:27:23 PM WAT
 ************************************************************************************************/