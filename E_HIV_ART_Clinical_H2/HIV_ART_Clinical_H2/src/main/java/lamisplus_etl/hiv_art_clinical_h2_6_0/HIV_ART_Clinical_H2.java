...
int count_tDBOutput_3=0;
                                ...
                                if(!whetherExist_tDBOutput_3) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_3 = conn_tDBOutput_3.createStatement()) {
                                        stmtCreate_tDBOutput_3.execute("CREATE TABLE \"" + tableName_tDBOutput_3 + "\"(\"created_date\" TIMESTAMP(29)   not null ,\"created_by\" VARCHAR(100)   not null ,\"last_modified_date\" TIMESTAMP(29)   not null ,\"last_modified_by\" VARCHAR(100)   not null ,\"uuid\" VARCHAR(100)   not null ,\"archived\" INT4  not null ,\"visit_date\" DATE ,\"cd_4\" FLOAT8 ,\"cd_4_percentage\" FLOAT8 ,\"is_commencement\" BOOL ,\"oi_screened\" VARCHAR(2000)  ,\"sti_ids\" VARCHAR(2000)  ,\"sti_treated\" VARCHAR(2000)  ,\"" + "opportunistic_infections" + "\" VARCHAR(2000),\"adr_screened\" VARCHAR(2000)  ,\"" + "adverse_drug_reactions" + "\" VARCHAR(2000),\"adherence_level\" VARCHAR(2000)  ,\"" + "adheres" + "\" VARCHAR(2000),\"next_appointment\" DATE ,\"lmp_date\" DATE ,\"functional_status\" VARCHAR(500)  ,\"clinical_stage\" VARCHAR(500)  ,\"datim_id\" VARCHAR(100)   not null ,\"hiv_enrollment_uuid\" VARCHAR(255)   not null ,\"visit_id\" VARCHAR(255)   not null ,\"person_uuid\" VARCHAR(255)   not null ,\"id\" INT4  not null ,\"regimen_id\" BIGSERIAL ,\"regimen_type_id\" INT4 ,\"" + "extra" + "\" VARCHAR(2000),\"notes\" VARCHAR(2000)  ,\"tb_status\" INT4 ,primary key(\"id\"))");
                                    }
                                }
...
pstmtUpdate_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
                        ...
                        pstmtUpdate_tDBOutput_3.setInt(6, clinic_stage_record.archived);
...
pstmtUpdate_tDBOutput_3.setNull(31, java.sql.Types.INTEGER);
                        ...
                        pstmtUpdate_tDBOutput_3.setInt(32 + count_tDBOutput_3, clinic_stage_record.id);
...
pstmtInsert_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
                        ...
                        pstmtInsert_tDBOutput_3.setInt(6, clinic_stage_record.archived);
...
/************************************************************************************************
 *     539006 characters generated by Talend Open Studio for Big Data 
 *     on the March 11, 2023 5:54:42 AM WAT
 ************************************************************************************************/