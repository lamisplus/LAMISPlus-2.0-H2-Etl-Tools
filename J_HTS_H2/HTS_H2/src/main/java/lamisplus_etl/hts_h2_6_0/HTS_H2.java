...
package lamisplus_etl.hts_h2_6_0;
...
/**
 * Job: HTS_H2 Purpose: HTS<br>
 * Description: HTS <br>
 * @author ilozuechukwuemeka@yahoo.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class HTS_H2 implements TalendJob {
...
public String getLAMIS3_H2_Login(){
	...
	private final String jobName = "HTS_H2";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HTS_H2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class facility_extractionStruct implements routines.system.IPersistableRow<facility_extractionStruct> {
    final static byte[] commonByteArrayLock_LAMISPLUS_ETL_HTS_H2 = new byte[0];
    static byte[] commonByteArray_LAMISPLUS_ETL_HTS_H2 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMISPLUS_ETL_HTS_H2.length) {
				if(length < 1024 && commonByteArray_LAMISPLUS_ETL_HTS_H2.length == 0) {
   					commonByteArray_LAMISPLUS_ETL_HTS_H2 = new byte[1024];
				} else {
   					commonByteArray_LAMISPLUS_ETL_HTS_H2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMISPLUS_ETL_HTS_H2, 0, length);
			strReturn = new String(commonByteArray_LAMISPLUS_ETL_HTS_H2, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_HTS_H2) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT h.hts_id as id, h.client_code, h.time_stamp AS date_created, \nh.date_visit,\n'ETL' AS created_by, h.time_stamp "
+"AS date_modified, \n'ETL' AS modified_by, h.super_tester_name AS captured_by,\n(CASE WHEN uuid IS NULL THEN CONCAT(h.hts"
+"_id, f.datim_id, h.hts_id)\nELSE h.uuid END) AS uuid, '0'::INTEGER archived,\njson_build_object('scrotalSwellingAndPain'"
+",  (CASE WHEN h.sti_screening4=0 THEN 'false' ELSE 'true' END),\n    'genitalSoreOrSwollenInguinalLymphNodes', (CASE WHE"
+"N h.sti_screening5=0 THEN 'false' ELSE 'true' END),\n    'vaginalDischargeOrBurningWhenUrinating', (CASE WHEN h.sti_scre"
+"ening2=0 THEN 'false' ELSE 'true' END),\n    'urethralDischargeOrBurningWhenUrinating', (CASE WHEN h.sti_screening3=0 TH"
+"EN 'false' ELSE 'true' END),\n    'lowerAbdominalPainsWithOrWithoutVaginalDischarge', (CASE WHEN h.sti_screening1=0 THEN"
+" 'false' ELSE 'true' END)\n	)::jsonb as sti_screening,\n	\njson_build_object('fever',  (CASE WHEN h.tb_screening3=0 THEN"
+" 'false' ELSE 'true' END),\n    'weightLoss', (CASE WHEN h.tb_screening2=0 THEN 'false' ELSE 'true' END),\n    'nightSwe"
+"ats', (CASE WHEN h.tb_screening4=0 THEN 'false' ELSE 'true' END),\n    'currentlyCough', (CASE WHEN h.tb_screening1=0 TH"
+"EN 'false' ELSE 'true' END),\n    'lymphadenopath', 'false'\n	)tb_screening,\n	\n	json_build_object('informConsentHivTes"
+"t',  (CASE WHEN h.knowledge_assessment7=0 THEN 'false' ELSE 'true' END),\n    'clientInformRiskkHivTrans', (CASE WHEN h."
+"knowledge_assessment4=0 THEN 'false' ELSE 'true' END),\n    'previousTestedHIVNegative', (CASE WHEN h.knowledge_assessme"
+"nt1=0 THEN 'false' ELSE 'true' END),\n    'clientInformHivTransRoutes', (CASE WHEN h.knowledge_assessment3=0 THEN 'false"
+"' ELSE 'true' END),\n	'timeLastHIVNegativeTestResult', '',\n    'clientInformPossibleTestResult', (CASE WHEN h.knowledge"
+"_assessment6=0 THEN 'false' ELSE 'true' END),\n	'clientInformPreventingsHivTrans', (CASE WHEN h.knowledge_assessment5=0 "
+"THEN 'false' ELSE 'true' END),\n	'clientPregnant', (CASE WHEN h.knowledge_assessment2=0 THEN 'false' ELSE 'true' END)\n	"
+")knowledge_assessment,\n	\njson_build_object('stiInLast3Months',  (CASE WHEN h.risk_assessment5=0 THEN 'false' ELSE 'tru"
+"e' END),\n    'everHadSexualIntercourse', (CASE WHEN h.risk_assessment1=0 THEN 'false' ELSE 'true' END),\n    'bloodTran"
+"sfusionInLast3Months', (CASE WHEN h.risk_assessment2=0 THEN 'false' ELSE 'true' END),\n    'moreThan1SexPartnerDuringLas"
+"t3Months', (CASE WHEN h.risk_assessment6=0 THEN 'false' ELSE 'true' END),\n    'unprotectedSexWithCasualPartnerInLast3Mo"
+"nths', (CASE WHEN h.risk_assessment3=0 THEN 'false' ELSE 'true' END),\n	'unprotectedSexWithRegularPartnerInLast3Months',"
+" (CASE WHEN h.risk_assessment4=0 THEN 'false' ELSE 'true' END)\n	)::jsonb as risk_assessment,\n	\n	json_build_object(\n "
+" 'hivTestBefore', (CASE WHEN h.initial_test_result ILIKE '%Neg%' THEN 'false' ELSE 'true' END),\n  'hivTestResult', (CAS"
+"E WHEN h.hiv_test_result ILIKE '%neg%' THEN 'false' ELSE 'true' END),\n  'informationFp', (CASE WHEN h.post_test9=0 THEN"
+" 'false' ELSE 'true' END),\n  'riskReduction', (CASE WHEN h.post_test5=0 THEN 'false' ELSE 'true' END),\n  'correctCondo"
+"mUse', (CASE WHEN h.post_test12=0 THEN 'false' ELSE 'true' END),\n  'hivRequestResult', (CASE WHEN h.post_test3=0 THEN '"
+"false' ELSE 'true' END),\n  'childrenHivtesting', (CASE WHEN h.post_test8=0 THEN 'false' ELSE 'true' END),\n  'hivReques"
+"tResultCt', (CASE WHEN h.post_test2=0 THEN 'false' ELSE 'true' END),\n  'partnerFpUseCondom', (CASE WHEN h.post_test11=0"
+" THEN 'false' ELSE 'true' END),\n  'postTestCounseling', (CASE WHEN h.post_test4=0 THEN 'false' ELSE 'true' END),\n  'po"
+"stTestDisclosure', (CASE WHEN h.post_test6=0 THEN 'false' ELSE 'true' END),\n  'referredToServices', (CASE WHEN h.post_t"
+"est14=0 THEN 'false' ELSE 'true' END),\n  'partnerFpThanCondom', (CASE WHEN h.post_test10=0 THEN 'false' ELSE 'true' END"
+"),\n  'bringPartnerHivtesting', (CASE WHEN h.post_test7=0 THEN 'false' ELSE 'true' END),\n  'condomProvidedToClient', (C"
+"ASE WHEN h.post_test13=0 THEN 'false' ELSE 'true' END),\n  'clientReceivedHivTestResult', (CASE WHEN h.risk_assessment5="
+"0 THEN 'false' ELSE 'true' END),\n  'unprotectedSexRegularPartnerLastThreeMonth', (CASE WHEN h.risk_assessment5=0 THEN '"
+"false' ELSE 'true' END)\n	)::jsonb as post_test_counseling,\n\njson_build_object(\n  'date', h.date_visit::varchar,\n  '"
+"result', \n	(CASE\n    WHEN lower(trim(left(h.test_result::VARCHAR, 2)))='re' THEN 'Yes'\n	WHEN lower(trim(left(h.test_r"
+"esult::VARCHAR, 2)))='no' THEN 'No'\n	ELSE\n	null\n  END)) test1,\n  (CASE WHEN h.confirmatory_test_result IS NOT NULL O"
+"R coalesce(h.confirmatory_test_result, '') != '' THEN\njson_build_object(\n  'date', h.date_visit::varchar, \n'result', "
+"\n	(CASE\n    WHEN lower(trim(left(h.confirmatory_test_result::VARCHAR, 2)))='re' THEN 'Yes'\n	WHEN lower(trim(left(h.co"
+"nfirmatory_test_result::VARCHAR, 2)))='no' THEN 'No'\n	ELSE\n	null\n  END)	\n) ELSE NULL END)confirmatory_test,\n(CASE W"
+"HEN h.tie_breaker_test_result IS NOT NULL OR  coalesce(h.tie_breaker_test_result, '') != '' THEN\njson_build_object(\n  "
+"'date', h.date_visit::varchar, \n'result', \n	  (CASE\n    WHEN lower(trim(left(h.tie_breaker_test_result::VARCHAR, 2)))"
+"='re' THEN 'Yes'\n	WHEN lower(trim(left(h.tie_breaker_test_result::VARCHAR, 2)))='no' THEN 'No'\n	ELSE\n	null\n  END)	\n"
+") ELSE NULL END)tie_breaker_test,\n(CASE WHEN h.tested_hiv ILIKE '%Not%' THEN false ELSE true END)  AS previously_tested"
+",\n  CASE\n    WHEN lower(trim(h.index_client))='yes' THEN true\n	WHEN lower(trim(h.index_client))='no' THEN false\n	ELS"
+"E\n	null\n  END \n  AS index_testing,\nh.num_children as num_children,\nh.num_wives as num_wives,\n  CASE\n    WHEN lowe"
+"r(trim(h.first_time_visit))='yes' THEN true\n	WHEN lower(trim(h.first_time_visit))='no' THEN false\n	ELSE\n	null\n  END "
+"\n  AS first_time_visit,\nh.index_client_code,\n\n(CASE\n    WHEN lower(trim(left(h.type_counseling,4)))='' THEN null\n	"
+"ELSE\n	lower(trim(left(h.type_counseling,4)))\n  END) as type_counseling,\n\nlower(left(h.referred_from,3)) as referred_"
+"from,\nlower(left(h.testing_setting,3)) as testing_setting,\n'' as target_group,\njson_build_object('surname', initcap(r"
+"eplace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(h.surname, '*', 'e'), '`'"
+", 'c'), '~', 'b'), '^', 'a'), '{', 'o'), '}', 'n'), '|', 'k'), '%', 'j'), '!', 'i'), '@', 'h'), '#', 'g'), '$', 'f')),\n"
+"				  'first_name', initcap(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(repl"
+"ace(h.other_names, '*', 'e'), '`', 'c'), '~', 'b'), '^', 'a'), '{', 'o'), '}', 'n'), '|', 'k'), '%', 'j'), '!', 'i'), '@"
+"', 'h'), '#', 'g'), '$', 'f')),\n				  'address', initcap(replace(replace(replace(replace(replace(replace(replace(replac"
+"e(replace(replace(replace(replace(h.address, '*', 'e'), '`', 'c'), '~', 'b'), '^', 'a'), '{', 'o'), '}', 'n'), '|', 'k')"
+", '%', 'j'), '!', 'i'), '@', 'h'), '#', 'g'), '$', 'f')),\n				  'middle_name', '',\n				  'date_of_birth', h.date_birth"
+"::varchar,\n				  'gender', h.gender,\n				  'phone_number', replace(replace(replace(replace(replace(replace(replace(rep"
+"lace(h.phone, '!', '9'), '@', '8'), '#', '7'), '$', '6'), '*', '5'), '`', '3'),'~', '2'),'^', '1'),\n				  'state_of_res"
+"idence', s.name,\n				  'lga_of_residence', l.name,\n				  'marital_status', h.marital_status)::jsonb as extra, \n				  "
+"\n				  json_build_object('optOutRTRI',  '',\n    'rencencyId',  '',\n    'sampleType',  '',\n    'controlLine',  '',\n "
+"   'hasViralLoad',  '',\n	'longTermLine',  '',\n	'recencyResult',  '',\n	'sampleTestDate',  '',\n	'receivingPcrLab',  ''"
+",\n	'verififcationLine',  '',\n	'finalRecencyResult',  '',\n	'optOutRTRITestDate',  '',\n	'optOutRTRITestName',  '',\n	'"
...
+"ecency,\n				  \nf.datim_id\nFROM hts h\nINNER JOIN state s ON s.state_id = h.state_id\nINNER JOIN lga l ON l.lga_id = h"
+".lga_id\nINNER JOIN facility f ON f.facility_id = h.facility_id";
        	...
        	hts_extract.client_code = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								hts_extract.date_created = null;
							} else {
										
			hts_extract.date_created = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 3);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								hts_extract.date_visit = null;
							} else {
										
			hts_extract.date_visit = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 4);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								hts_extract.created_by = null;
							} else {
	                         		
        	hts_extract.created_by = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								hts_extract.date_modified = null;
							} else {
										
			hts_extract.date_modified = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 6);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								hts_extract.modified_by = null;
							} else {
	                         		
        	hts_extract.modified_by = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								hts_extract.captured_by = null;
							} else {
	                         		
        	hts_extract.captured_by = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								hts_extract.uuid = null;
							} else {
	                         		
        	hts_extract.uuid = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								hts_extract.archived = null;
							} else {
		                          
            hts_extract.archived = rs_tDBInput_1.getInt(10);
            if(rs_tDBInput_1.wasNull()){
                    hts_extract.archived = null;
            }
		                    }
        	...
        	hts_extract.sti_screening = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								hts_extract.tb_screening = null;
							} else {
	                         		
        	hts_extract.tb_screening = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								hts_extract.knowledge_assessment = null;
							} else {
	                         		
        	hts_extract.knowledge_assessment = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								hts_extract.risk_assessment = null;
							} else {
	                         		
        	hts_extract.risk_assessment = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								hts_extract.post_test_counseling = null;
							} else {
	                         		
        	hts_extract.post_test_counseling = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 16) {
								hts_extract.test1 = null;
							} else {
	                         		
        	hts_extract.test1 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 17) {
								hts_extract.confirmatory_test = null;
							} else {
	                         		
        	hts_extract.confirmatory_test = routines.system.JDBCUtil.getString(rs_tDBInput_1, 17, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 18) {
								hts_extract.tie_breaker_test = null;
							} else {
	                         		
        	hts_extract.tie_breaker_test = routines.system.JDBCUtil.getString(rs_tDBInput_1, 18, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 19) {
								hts_extract.previously_tested = null;
							} else {
	                         		
            hts_extract.previously_tested = rs_tDBInput_1.getBoolean(19);
            if(rs_tDBInput_1.wasNull()){
                    hts_extract.previously_tested = null;
            }
		                    }
            ...
            hts_extract.index_testing = rs_tDBInput_1.getBoolean(20);
            if(rs_tDBInput_1.wasNull()){
                    hts_extract.index_testing = null;
            }
		                    }
            ...
            hts_extract.num_children = rs_tDBInput_1.getInt(21);
            if(rs_tDBInput_1.wasNull()){
                    hts_extract.num_children = null;
            }
		                    }
            ...
            hts_extract.num_wives = rs_tDBInput_1.getInt(22);
            if(rs_tDBInput_1.wasNull()){
                    hts_extract.num_wives = null;
            }
		                    }
            ...
            hts_extract.first_time_visit = rs_tDBInput_1.getBoolean(23);
            if(rs_tDBInput_1.wasNull()){
                    hts_extract.first_time_visit = null;
            }
		                    }
        	...
        	hts_extract.index_client_code = routines.system.JDBCUtil.getString(rs_tDBInput_1, 24, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 25) {
								hts_extract.type_counseling = null;
							} else {
	                         		
        	hts_extract.type_counseling = routines.system.JDBCUtil.getString(rs_tDBInput_1, 25, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 26) {
								hts_extract.referred_from = null;
							} else {
	                         		
        	hts_extract.referred_from = routines.system.JDBCUtil.getString(rs_tDBInput_1, 26, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 27) {
								hts_extract.testing_setting = null;
							} else {
	                         		
        	hts_extract.testing_setting = routines.system.JDBCUtil.getString(rs_tDBInput_1, 27, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 28) {
								hts_extract.target_group = null;
							} else {
	                         		
        	hts_extract.target_group = routines.system.JDBCUtil.getString(rs_tDBInput_1, 28, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 29) {
								hts_extract.extra = null;
							} else {
	                         		
        	hts_extract.extra = routines.system.JDBCUtil.getString(rs_tDBInput_1, 29, false);
		                    }
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = context.LAMISPlus_Password; 
		    ...
		    String dbquery_tDBInput_3 = "SELECT DISTINCT c.id as codeset_id,codeset_group,lower(left(c.display,3)) as codeset_display, code\nFROM public.base_ap"
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = context.LAMISPlus_Password; 
		    ...
		    String dbquery_tDBInput_4 = "SELECT DISTINCT c.id as codeset_id,codeset_group,lower(left(c.display,3)) as codeset_display, code\nFROM public.base_ap"
 ...
 */
    ...
    public static void main(String[] args){
        final HTS_H2 HTS_H2Class = new HTS_H2();

        int exitCode = HTS_H2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HTS_H2.class.getClassLoader().getResourceAsStream("lamisplus_etl/hts_h2_6_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HTS_H2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HTS_H2");
        }
...
/************************************************************************************************
 *     346453 characters generated by Talend Open Studio for Big Data 
 *     on the March 25, 2023 1:31:15 AM WAT
 ************************************************************************************************/