...
package lamisplus_etl.laboratory_h2_6_0;
...
/**
 * Job: Laboratory_H2 Purpose: Laboratory<br>
 * Description: Laboratory <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Laboratory_H2 implements TalendJob {
...
public String getLAMIS3_H2_Login(){
	...
	private final String jobName = "Laboratory_H2";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Laboratory_H2.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Laboratory_H2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class laboratory_orde_finalStruct implements routines.system.IPersistableRow<laboratory_orde_finalStruct> {
    final static byte[] commonByteArrayLock_LAMISPLUS_ETL_Laboratory_H2 = new byte[0];
    static byte[] commonByteArray_LAMISPLUS_ETL_Laboratory_H2 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMISPLUS_ETL_Laboratory_H2.length) {
				if(length < 1024 && commonByteArray_LAMISPLUS_ETL_Laboratory_H2.length == 0) {
   					commonByteArray_LAMISPLUS_ETL_Laboratory_H2 = new byte[1024];
				} else {
   					commonByteArray_LAMISPLUS_ETL_Laboratory_H2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMISPLUS_ETL_Laboratory_H2, 0, length);
			strReturn = new String(commonByteArray_LAMISPLUS_ETL_Laboratory_H2, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_Laboratory_H2) {
...
public static class laboratory_orderStruct implements routines.system.IPersistableRow<laboratory_orderStruct> {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_Laboratory_H2) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.laboratory_id = dis.readInt();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.laboratory_id);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("laboratory_id="+String.valueOf(laboratory_id));
		sb.append(",patient_id="+String.valueOf(patient_id));
		sb.append(",order_date="+String.valueOf(order_date));
		sb.append(",patient_uuid="+patient_uuid);
		sb.append(",archived="+String.valueOf(archived));
...
public static class after_tDBInput_1Struct implements routines.system.IPersistableRow<after_tDBInput_1Struct> {
	...
	public void copyDataTo(after_tDBInput_1Struct other) {
		...
		other.laboratory_id = this.laboratory_id;
	            other.patient_id = this.patient_id;
	            other.order_date = this.order_date;
	            other.patient_uuid = this.patient_uuid;
	            other.archived = this.archived;
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.LAMIS3_H2_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT DISTINCT la.laboratory_id, la.patient_id, la.date_reported AS order_date, p.id_uuid AS patient_uuid,\n0 AS archi"
+"ved, la.time_stamp AS date_created, la.time_stamp AS date_modified,\n'ETL' AS created_by, 'ETL' AS modified_by, CONCAT('"
+"l', la.laboratory_id, p.id_uuid,la.laboratory_id,'l') uuid,\nf.datim_id\nFROM laboratory la\nINNER JOIN (SELECT * FROM(S"
+"ELECT laboratory_id, \n					 ROW_NUMBER() \n					 OVER (PARTITION BY patient_id, date_reported \n						   ORDER BY labor"
+"atory_id DESC) FROM laboratory)l WHERE l.row_number=1)l ON l.laboratory_id=la.laboratory_id\nINNER JOIN facility f ON f."
+"facility_id=la.facility_id\nINNER JOIN patient p ON p.patient_id = la.patient_id";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								laboratory_order.laboratory_id = 0;
							} else {
		                          
            laboratory_order.laboratory_id = rs_tDBInput_1.getInt(1);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								laboratory_order.patient_id = 0;
							} else {
		                          
            laboratory_order.patient_id = rs_tDBInput_1.getLong(2);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
			...
			laboratory_order.order_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 3);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								laboratory_order.patient_uuid = null;
							} else {
	                         		
        	laboratory_order.patient_uuid = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								laboratory_order.archived = 0;
							} else {
		                          
            laboratory_order.archived = rs_tDBInput_1.getInt(5);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								laboratory_order.date_created = null;
							} else {
										
			laboratory_order.date_created = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 6);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								laboratory_order.date_modified = null;
							} else {
										
			laboratory_order.date_modified = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 7);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								laboratory_order.created_by = null;
							} else {
	                         		
        	laboratory_order.created_by = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								laboratory_order.modified_by = null;
							} else {
	                         		
        	laboratory_order.modified_by = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								laboratory_order.uuid = null;
							} else {
	                         		
        	laboratory_order.uuid = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								laboratory_order.datim_id = null;
							} else {
	                         		
        	laboratory_order.datim_id = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
		                    }
...
laboratory_order_extract_tmp.id = laboratory_order.laboratory_id ;
laboratory_order_extract_tmp.date_created = laboratory_order.date_created ;
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = context.LAMIS3_H2_Password; 
		    ...
		    String dbquery_tDBInput_4 = "SELECT la.laboratory_id AS id, la.comment AS description, la.comment AS indication, \nlower(left(la.comment,6)) AS indi"
+"cation_display, lt.description as lab_test_description,\nlt.measureab as unit_measurement, 5 as lab_test_order_status, 0"
+" as order_priority, \nla.labno as lab_number, ltc.category as lab_test_group, p.id_uuid as person_uuid, la.date_reported"
+" AS order_date\nFROM laboratory la\nINNER JOIN labtest lt ON la.labtest_id=lt.labtest_id\nINNER JOIN labtestcategory ltc"
+" ON lt.labtestcategory_id = ltc.labtestcategory_id\nINNER JOIN patient p ON p.patient_id=la.patient_id";
        	...
        	laboratory_test_extract.person_uuid = routines.system.JDBCUtil.getString(rs_tDBInput_4, 11, false);
							...
							if(colQtyInRs_tDBInput_4 < 12) {
								laboratory_test_extract.order_date = null;
							} else {
										
			laboratory_test_extract.order_date = routines.system.JDBCUtil.getDate(rs_tDBInput_4, 12);
		                    }
...
laboratory_application_codeset_extract_tmp.order_date = laboratory_test_extract.order_date ;
...
laboratory_test_group_codeset_tmp.order_date = laboratory_application_codeset_extract.order_date ;
...
laboratory_test_person_tmp.order_date = laboratory_test_group_codeset.order_date ;
 					    ...
 					    boolean forceLooplaboratory_order_ids = false;
 							...
 							laboratory_order_idsStruct laboratory_order_idsObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_9 = false;
                        		    		    ...
                        		    		    laboratory_order_idsHashKey.order_date = laboratory_test_person.order_date  == null ? null : new java.util.Date(laboratory_test_person.order_date .getTime());
                        		    		
                        		    		    laboratory_order_idsHashKey.patient_uuid = laboratory_test_person.patient_uuid;
				           		...
				           		if(tHash_Lookup_laboratory_order_ids != null && tHash_Lookup_laboratory_order_ids.getCount(laboratory_order_idsHashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'laboratory_order_ids' and it contains more one result from keys :  laboratory_order_ids.order_date = '" + laboratory_order_idsHashKey.order_date + "', laboratory_order_ids.patient_uuid = '" + laboratory_order_idsHashKey.patient_uuid + "'");
								} // G 071
...
public static class laboratory_sample_extractStruct implements routines.system.IPersistableRow<laboratory_sample_extractStruct> {
    ...
    static byte[] commonByteArray_LAMISPLUS_ETL_Laboratory_H2 = new byte[0];
			    ...
			    public java.util.Date date_reported;

				public java.util.Date getDate_reported () {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_Laboratory_H2) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.date_reported = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.date_reported,dos);
    ...
    public String toString() {
		...
		sb.append("id="+String.valueOf(id));
		sb.append(",date_sample_collected="+String.valueOf(date_sample_collected));
		sb.append(",date_reported="+String.valueOf(date_reported));
		sb.append(",person_uuid="+person_uuid);
		sb.append(",archived="+String.valueOf(archived));
		sb.append(",date_created="+String.valueOf(date_created));
		sb.append(",date_modified="+String.valueOf(date_modified));
 ...
 */
	...
	final String decryptedPassword_tDBInput_13 = context.LAMIS3_H2_Password; 
		    ...
		    String dbquery_tDBInput_13 = "SELECT la.laboratory_id AS id, la.date_collected AS date_sample_collected, la.date_reported,\np.id_uuid AS person_uuid,"
+" 0 AS archived, la.time_stamp AS date_created, la.time_stamp AS date_modified,\n'ETL' AS created_by, 'ETL' AS modified_b"
+"y\n\nFROM laboratory la\nINNER JOIN patient p ON p.patient_id=la.patient_id";
			...
			laboratory_sample_extract.date_sample_collected = routines.system.JDBCUtil.getDate(rs_tDBInput_13, 2);
		                    }
							if(colQtyInRs_tDBInput_13 < 3) {
								laboratory_sample_extract.date_reported = null;
							} else {
										
			laboratory_sample_extract.date_reported = routines.system.JDBCUtil.getDate(rs_tDBInput_13, 3);
		                    }
							if(colQtyInRs_tDBInput_13 < 4) {
								laboratory_sample_extract.person_uuid = null;
							} else {
	                         		
        	laboratory_sample_extract.person_uuid = routines.system.JDBCUtil.getString(rs_tDBInput_13, 4, false);
		                    }
							if(colQtyInRs_tDBInput_13 < 5) {
								laboratory_sample_extract.archived = null;
							} else {
		                          
            laboratory_sample_extract.archived = rs_tDBInput_13.getInt(5);
            if(rs_tDBInput_13.wasNull()){
                    laboratory_sample_extract.archived = null;
            }
		                    }
							if(colQtyInRs_tDBInput_13 < 6) {
								laboratory_sample_extract.date_created = null;
							} else {
										
			laboratory_sample_extract.date_created = routines.system.JDBCUtil.getDate(rs_tDBInput_13, 6);
		                    }
							if(colQtyInRs_tDBInput_13 < 7) {
								laboratory_sample_extract.date_modified = null;
							} else {
										
			laboratory_sample_extract.date_modified = routines.system.JDBCUtil.getDate(rs_tDBInput_13, 7);
		                    }
							if(colQtyInRs_tDBInput_13 < 8) {
								laboratory_sample_extract.created_by = null;
							} else {
	                         		
        	laboratory_sample_extract.created_by = routines.system.JDBCUtil.getString(rs_tDBInput_13, 8, false);
		                    }
							if(colQtyInRs_tDBInput_13 < 9) {
								laboratory_sample_extract.modified_by = null;
							} else {
	                         		
        	laboratory_sample_extract.modified_by = routines.system.JDBCUtil.getString(rs_tDBInput_13, 9, false);
		                    }
 					    ...
 					    boolean forceLooplaboratory_order_data = false;
 							...
 							laboratory_order_dataStruct laboratory_order_dataObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_10 = false;
                        		    		    ...
                        		    		    laboratory_order_dataHashKey.order_date = laboratory_sample_extract.date_reported == null ? null : new java.util.Date(laboratory_sample_extract.date_reported.getTime());
                        		    		
                        		    		    laboratory_order_dataHashKey.patient_uuid = laboratory_sample_extract.person_uuid;
				           		...
				           		if(tHash_Lookup_laboratory_order_data != null && tHash_Lookup_laboratory_order_data.getCount(laboratory_order_dataHashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'laboratory_order_data' and it contains more one result from keys :  laboratory_order_data.order_date = '" + laboratory_order_dataHashKey.order_date + "', laboratory_order_data.patient_uuid = '" + laboratory_order_dataHashKey.patient_uuid + "'");
								} // G 071
...
laboratory_sample_order_tmp.created_by = laboratory_sample_extract.created_by ;
laboratory_sample_order_tmp.date_created = laboratory_sample_extract.date_created ;
laboratory_sample_order_tmp.modified_by = laboratory_sample_extract.modified_by ;
laboratory_sample_order_tmp.date_modified = laboratory_sample_extract.date_modified ;
laboratory_sample_order_tmp.test_id = laboratory_order_data.test_id ;
laboratory_sample_order_tmp.archived = laboratory_sample_extract.archived ;
	...
	currentComponent="tDBInput_12";
		...
		int tos_count_tDBInput_12 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_12 = null;
				...
				String dbUser_tDBInput_12 = context.LAMIS3_H2_Login;
				
				
	final String decryptedPassword_tDBInput_12 = context.LAMIS3_H2_Password; 
				
				String dbPwd_tDBInput_12 = decryptedPassword_tDBInput_12;
				
				String url_tDBInput_12 = "jdbc:postgresql://" + context.LAMIS3_H2_Server + ":" + context.LAMIS3_H2_Port + "/" + context.LAMIS3_H2_Database + "?" + context.LAMIS3_H2_AdditionalParams;
		    ...
		    String dbquery_tDBInput_12 = "SELECT la.laboratory_id AS id, la.resultab AS result_reported, la.date_reported AS date_result_reported,\nla.date_colle"
+"cted AS date_assayed,\np.id_uuid AS person_uuid, 0 AS archived, la.time_stamp AS date_created, la.time_stamp AS date_mod"
+"ified,\n'ETL' AS created_by, 'ETL' AS modified_by\n\nFROM laboratory la\nINNER JOIN patient p ON p.patient_id=la.patient"
+"_id";
            ...
            laboratory_result_records.id = rs_tDBInput_12.getLong(1);
			...
			laboratory_result_records.date_assayed = routines.system.JDBCUtil.getDate(rs_tDBInput_12, 4);
		                    }
							if(colQtyInRs_tDBInput_12 < 5) {
								laboratory_result_records.person_uuid = null;
							} else {
	                         		
        	laboratory_result_records.person_uuid = routines.system.JDBCUtil.getString(rs_tDBInput_12, 5, false);
		                    }
							if(colQtyInRs_tDBInput_12 < 6) {
								laboratory_result_records.archived = null;
							} else {
		                          
            laboratory_result_records.archived = rs_tDBInput_12.getInt(6);
            if(rs_tDBInput_12.wasNull()){
                    laboratory_result_records.archived = null;
            }
		                    }
							if(colQtyInRs_tDBInput_12 < 7) {
								laboratory_result_records.date_created = null;
							} else {
										
			laboratory_result_records.date_created = routines.system.JDBCUtil.getDate(rs_tDBInput_12, 7);
		                    }
							if(colQtyInRs_tDBInput_12 < 8) {
								laboratory_result_records.date_modified = null;
							} else {
										
			laboratory_result_records.date_modified = routines.system.JDBCUtil.getDate(rs_tDBInput_12, 8);
		                    }
							if(colQtyInRs_tDBInput_12 < 9) {
								laboratory_result_records.created_by = null;
							} else {
	                         		
        	laboratory_result_records.created_by = routines.system.JDBCUtil.getString(rs_tDBInput_12, 9, false);
		                    }
							if(colQtyInRs_tDBInput_12 < 10) {
								laboratory_result_records.modified_by = null;
							} else {
	                         		
        	laboratory_result_records.modified_by = routines.system.JDBCUtil.getString(rs_tDBInput_12, 10, false);
		                    }
 					    ...
 					    boolean forceLooplaboratory_order_result = false;
 							...
 							laboratory_order_resultStruct laboratory_order_resultObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_11 = false;
                        		    		    ...
                        		    		    laboratory_order_resultHashKey.order_date = laboratory_result_records.date_result_reported  == null ? null : new java.util.Date(laboratory_result_records.date_result_reported .getTime());
                        		    		
                        		    		    laboratory_order_resultHashKey.patient_uuid = laboratory_result_records.person_uuid ;
				           		...
				           		if(tHash_Lookup_laboratory_order_result != null && tHash_Lookup_laboratory_order_result.getCount(laboratory_order_resultHashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'laboratory_order_result' and it contains more one result from keys :  laboratory_order_result.order_date = '" + laboratory_order_resultHashKey.order_date + "', laboratory_order_result.patient_uuid = '" + laboratory_order_resultHashKey.patient_uuid + "'");
								} // G 071
...
laboratory_result_extracts_tmp.created_by = laboratory_result_records.created_by ;
laboratory_result_extracts_tmp.date_created = laboratory_result_records.date_created ;
laboratory_result_extracts_tmp.modified_by = laboratory_result_records.modified_by ;
laboratory_result_extracts_tmp.date_modified = laboratory_result_records.date_modified ;
laboratory_result_extracts_tmp.test_id = laboratory_order_result.test_id ;
laboratory_result_extracts_tmp.archived = laboratory_result_records.archived ;
...
public static class laboratory_order_idsStruct implements routines.system.IPersistableComparableLookupRow<laboratory_order_idsStruct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.patient_uuid == null) ? 0 : this.patient_uuid.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final laboratory_order_idsStruct other = (laboratory_order_idsStruct) obj;
						...
						if (this.patient_uuid == null) {
							if (other.patient_uuid != null)
								return false;
						
						} else if (!this.patient_uuid.equals(other.patient_uuid))
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.patient_id = readInteger(dis,ois);
					
						this.visit_id = readInteger(dis,ois);
					
						this.facility_id = readInteger(dis,ois);
					
						this.create_date = readDate(dis,ois);
					
						this.userid = readString(dis,ois);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.patient_id, dos, oos);
					
					writeInteger(this.visit_id, dos, oos);
					
					writeInteger(this.facility_id, dos, oos);
					
						writeDate(this.create_date, dos, oos);
					
						writeString(this.userid, dos, oos);
    ...
    public int compareTo(laboratory_order_idsStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.patient_uuid, other.patient_uuid);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	final String decryptedPassword_tDBInput_9 = context.LAMISPlus_Password; 
		    ...
		    String dbquery_tDBInput_9 = "SELECT * FROM laboratory_order";
            ...
            if(rs_tDBInput_9.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tDBInput_9 < 2) {
								laboratory_order_ids.uuid = null;
							} else {
	                         		
        	laboratory_order_ids.uuid = routines.system.JDBCUtil.getString(rs_tDBInput_9, 2, false);
		                    }
							if(colQtyInRs_tDBInput_9 < 3) {
								laboratory_order_ids.patient_id = null;
							} else {
		                          
            laboratory_order_ids.patient_id = rs_tDBInput_9.getInt(3);
            if(rs_tDBInput_9.wasNull()){
                    laboratory_order_ids.patient_id = null;
            }
		                    }
							if(colQtyInRs_tDBInput_9 < 4) {
								laboratory_order_ids.visit_id = null;
							} else {
		                          
            laboratory_order_ids.visit_id = rs_tDBInput_9.getInt(4);
            if(rs_tDBInput_9.wasNull()){
                    laboratory_order_ids.visit_id = null;
            }
		                    }
							if(colQtyInRs_tDBInput_9 < 5) {
								laboratory_order_ids.order_date = null;
							} else {
										
			laboratory_order_ids.order_date = routines.system.JDBCUtil.getDate(rs_tDBInput_9, 5);
		                    }
							if(colQtyInRs_tDBInput_9 < 6) {
								laboratory_order_ids.patient_uuid = null;
							} else {
	                         		
        	laboratory_order_ids.patient_uuid = routines.system.JDBCUtil.getString(rs_tDBInput_9, 6, false);
		                    }
							if(colQtyInRs_tDBInput_9 < 7) {
								laboratory_order_ids.facility_id = null;
							} else {
		                          
            laboratory_order_ids.facility_id = rs_tDBInput_9.getInt(7);
            if(rs_tDBInput_9.wasNull()){
                    laboratory_order_ids.facility_id = null;
            }
		                    }
							if(colQtyInRs_tDBInput_9 < 8) {
								laboratory_order_ids.create_date = null;
							} else {
										
			laboratory_order_ids.create_date = routines.system.JDBCUtil.getDate(rs_tDBInput_9, 8);
		                    }
							if(colQtyInRs_tDBInput_9 < 9) {
								laboratory_order_ids.userid = null;
							} else {
	                         		
        	laboratory_order_ids.userid = routines.system.JDBCUtil.getString(rs_tDBInput_9, 9, false);
		                    }
							if(colQtyInRs_tDBInput_9 < 10) {
								laboratory_order_ids.created_by = null;
							} else {
	                         		
        	laboratory_order_ids.created_by = routines.system.JDBCUtil.getString(rs_tDBInput_9, 10, false);
		                    }
							if(colQtyInRs_tDBInput_9 < 11) {
								laboratory_order_ids.date_created = null;
							} else {
										
			laboratory_order_ids.date_created = routines.system.JDBCUtil.getDate(rs_tDBInput_9, 11);
		                    }
							if(colQtyInRs_tDBInput_9 < 12) {
								laboratory_order_ids.modified_by = null;
							} else {
	                         		
        	laboratory_order_ids.modified_by = routines.system.JDBCUtil.getString(rs_tDBInput_9, 12, false);
		                    }
							if(colQtyInRs_tDBInput_9 < 13) {
								laboratory_order_ids.date_modified = null;
							} else {
										
			laboratory_order_ids.date_modified = routines.system.JDBCUtil.getDate(rs_tDBInput_9, 13);
		                    }
							if(colQtyInRs_tDBInput_9 < 14) {
								laboratory_order_ids.archived = null;
							} else {
		                          
            laboratory_order_ids.archived = rs_tDBInput_9.getInt(14);
            if(rs_tDBInput_9.wasNull()){
                    laboratory_order_ids.archived = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_laboratory_order_ids";
				...
				laboratory_order_ids_HashRow.uuid = laboratory_order_ids.uuid;
				
				laboratory_order_ids_HashRow.patient_id = laboratory_order_ids.patient_id;
				
				laboratory_order_ids_HashRow.visit_id = laboratory_order_ids.visit_id;
				
				laboratory_order_ids_HashRow.order_date = laboratory_order_ids.order_date;
				
				laboratory_order_ids_HashRow.patient_uuid = laboratory_order_ids.patient_uuid;
				
				laboratory_order_ids_HashRow.facility_id = laboratory_order_ids.facility_id;
				
				laboratory_order_ids_HashRow.create_date = laboratory_order_ids.create_date;
				
				laboratory_order_ids_HashRow.userid = laboratory_order_ids.userid;
 ...
 */
	...
	final String decryptedPassword_tDBInput_14 = context.LAMISPlus_Password; 
            ...
            laboratory_order_data.id = rs_tDBInput_14.getLong(1);
            if(rs_tDBInput_14.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_14 < 2) {
								laboratory_order_data.uuid = null;
							} else {
	                         		
        	laboratory_order_data.uuid = routines.system.JDBCUtil.getString(rs_tDBInput_14, 2, false);
		                    }
							if(colQtyInRs_tDBInput_14 < 3) {
								laboratory_order_data.patient_id = null;
							} else {
		                          
            laboratory_order_data.patient_id = rs_tDBInput_14.getInt(3);
            if(rs_tDBInput_14.wasNull()){
                    laboratory_order_data.patient_id = null;
            }
		                    }
							if(colQtyInRs_tDBInput_14 < 4) {
								laboratory_order_data.visit_id = null;
							} else {
		                          
            laboratory_order_data.visit_id = rs_tDBInput_14.getInt(4);
            if(rs_tDBInput_14.wasNull()){
                    laboratory_order_data.visit_id = null;
            }
		                    }
							if(colQtyInRs_tDBInput_14 < 5) {
								laboratory_order_data.order_date = null;
							} else {
										
			laboratory_order_data.order_date = routines.system.JDBCUtil.getDate(rs_tDBInput_14, 5);
		                    }
							if(colQtyInRs_tDBInput_14 < 6) {
								laboratory_order_data.patient_uuid = null;
							} else {
	                         		
        	laboratory_order_data.patient_uuid = routines.system.JDBCUtil.getString(rs_tDBInput_14, 6, false);
		                    }
							if(colQtyInRs_tDBInput_14 < 7) {
								laboratory_order_data.facility_id = null;
							} else {
		                          
            laboratory_order_data.facility_id = rs_tDBInput_14.getInt(7);
            if(rs_tDBInput_14.wasNull()){
                    laboratory_order_data.facility_id = null;
            }
		                    }
							if(colQtyInRs_tDBInput_14 < 8) {
								laboratory_order_data.create_date = null;
							} else {
										
			laboratory_order_data.create_date = routines.system.JDBCUtil.getDate(rs_tDBInput_14, 8);
		                    }
							if(colQtyInRs_tDBInput_14 < 9) {
								laboratory_order_data.userid = null;
							} else {
	                         		
        	laboratory_order_data.userid = routines.system.JDBCUtil.getString(rs_tDBInput_14, 9, false);
		                    }
							if(colQtyInRs_tDBInput_14 < 10) {
								laboratory_order_data.created_by = null;
							} else {
	                         		
        	laboratory_order_data.created_by = routines.system.JDBCUtil.getString(rs_tDBInput_14, 10, false);
		                    }
							if(colQtyInRs_tDBInput_14 < 11) {
								laboratory_order_data.date_created = null;
							} else {
										
			laboratory_order_data.date_created = routines.system.JDBCUtil.getDate(rs_tDBInput_14, 11);
		                    }
							if(colQtyInRs_tDBInput_14 < 12) {
								laboratory_order_data.modified_by = null;
							} else {
	                         		
        	laboratory_order_data.modified_by = routines.system.JDBCUtil.getString(rs_tDBInput_14, 12, false);
		                    }
							if(colQtyInRs_tDBInput_14 < 13) {
								laboratory_order_data.date_modified = null;
							} else {
										
			laboratory_order_data.date_modified = routines.system.JDBCUtil.getDate(rs_tDBInput_14, 13);
		                    }
							if(colQtyInRs_tDBInput_14 < 14) {
								laboratory_order_data.archived = null;
							} else {
		                          
            laboratory_order_data.archived = rs_tDBInput_14.getInt(14);
            if(rs_tDBInput_14.wasNull()){
                    laboratory_order_data.archived = null;
            }
		                    }
            ...
            laboratory_order_data.test_id = rs_tDBInput_14.getInt(15);
            if(rs_tDBInput_14.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_laboratory_order_data";
				...
				laboratory_order_data_HashRow.uuid = laboratory_order_data.uuid;
				
				laboratory_order_data_HashRow.patient_id = laboratory_order_data.patient_id;
				
				laboratory_order_data_HashRow.visit_id = laboratory_order_data.visit_id;
				
				laboratory_order_data_HashRow.order_date = laboratory_order_data.order_date;
				
				laboratory_order_data_HashRow.patient_uuid = laboratory_order_data.patient_uuid;
				
				laboratory_order_data_HashRow.facility_id = laboratory_order_data.facility_id;
				
				laboratory_order_data_HashRow.create_date = laboratory_order_data.create_date;
				
				laboratory_order_data_HashRow.userid = laboratory_order_data.userid;
...
public static class laboratory_order_resultStruct implements routines.system.IPersistableComparableLookupRow<laboratory_order_resultStruct> {
    ...
    public String loopKey;
			    ...
			    public Integer archived1;

				public Integer getArchived1 () {
					return this.archived1;
				}
	...
	public void copyDataTo(laboratory_order_resultStruct other) {
		...
		other.id = this.id;
	            ...
	            other.archived = this.archived;
	            other.test_id = this.test_id;
	            other.archived1 = this.archived1;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.archived1 = readInteger(dis,ois);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.archived1, dos, oos);
    ...
    public String toString() {
		...
		sb.append(",archived="+String.valueOf(archived));
		sb.append(",test_id="+String.valueOf(test_id));
		sb.append(",archived1="+String.valueOf(archived1));
	    sb.append("]");
 ...
 */
	...
	final String decryptedPassword_tDBInput_15 = context.LAMISPlus_Password; 
		    ...
		    String dbquery_tDBInput_15 = "SELECT lo.*, lt.id as test_id, lo.archived\nFROM laboratory_order lo\nINNER JOIN laboratory_test lt ON lt.lab_order_id="
+"lo.id";
            ...
            laboratory_order_result.id = rs_tDBInput_15.getLong(1);
            if(rs_tDBInput_15.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_15 < 2) {
								laboratory_order_result.uuid = null;
							} else {
	                         		
        	laboratory_order_result.uuid = routines.system.JDBCUtil.getString(rs_tDBInput_15, 2, false);
		                    }
							if(colQtyInRs_tDBInput_15 < 3) {
								laboratory_order_result.patient_id = null;
							} else {
		                          
            laboratory_order_result.patient_id = rs_tDBInput_15.getInt(3);
            if(rs_tDBInput_15.wasNull()){
                    laboratory_order_result.patient_id = null;
            }
		                    }
							if(colQtyInRs_tDBInput_15 < 4) {
								laboratory_order_result.visit_id = null;
							} else {
		                          
            laboratory_order_result.visit_id = rs_tDBInput_15.getInt(4);
            if(rs_tDBInput_15.wasNull()){
                    laboratory_order_result.visit_id = null;
            }
		                    }
							if(colQtyInRs_tDBInput_15 < 5) {
								laboratory_order_result.order_date = null;
							} else {
										
			laboratory_order_result.order_date = routines.system.JDBCUtil.getDate(rs_tDBInput_15, 5);
		                    }
							if(colQtyInRs_tDBInput_15 < 6) {
								laboratory_order_result.patient_uuid = null;
							} else {
	                         		
        	laboratory_order_result.patient_uuid = routines.system.JDBCUtil.getString(rs_tDBInput_15, 6, false);
		                    }
							if(colQtyInRs_tDBInput_15 < 7) {
								laboratory_order_result.facility_id = null;
							} else {
		                          
            laboratory_order_result.facility_id = rs_tDBInput_15.getInt(7);
            if(rs_tDBInput_15.wasNull()){
                    laboratory_order_result.facility_id = null;
            }
		                    }
							if(colQtyInRs_tDBInput_15 < 8) {
								laboratory_order_result.create_date = null;
							} else {
										
			laboratory_order_result.create_date = routines.system.JDBCUtil.getDate(rs_tDBInput_15, 8);
		                    }
							if(colQtyInRs_tDBInput_15 < 9) {
								laboratory_order_result.userid = null;
							} else {
	                         		
        	laboratory_order_result.userid = routines.system.JDBCUtil.getString(rs_tDBInput_15, 9, false);
		                    }
							if(colQtyInRs_tDBInput_15 < 10) {
								laboratory_order_result.created_by = null;
							} else {
	                         		
        	laboratory_order_result.created_by = routines.system.JDBCUtil.getString(rs_tDBInput_15, 10, false);
		                    }
							if(colQtyInRs_tDBInput_15 < 11) {
								laboratory_order_result.date_created = null;
							} else {
										
			laboratory_order_result.date_created = routines.system.JDBCUtil.getDate(rs_tDBInput_15, 11);
		                    }
							if(colQtyInRs_tDBInput_15 < 12) {
								laboratory_order_result.modified_by = null;
							} else {
	                         		
        	laboratory_order_result.modified_by = routines.system.JDBCUtil.getString(rs_tDBInput_15, 12, false);
		                    }
							if(colQtyInRs_tDBInput_15 < 13) {
								laboratory_order_result.date_modified = null;
							} else {
										
			laboratory_order_result.date_modified = routines.system.JDBCUtil.getDate(rs_tDBInput_15, 13);
		                    }
							if(colQtyInRs_tDBInput_15 < 14) {
								laboratory_order_result.archived = null;
							} else {
		                          
            laboratory_order_result.archived = rs_tDBInput_15.getInt(14);
            if(rs_tDBInput_15.wasNull()){
                    laboratory_order_result.archived = null;
            }
		                    }
            ...
            laboratory_order_result.test_id = rs_tDBInput_15.getInt(15);
            if(rs_tDBInput_15.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_15 < 16) {
								laboratory_order_result.archived1 = null;
							} else {
		                          
            laboratory_order_result.archived1 = rs_tDBInput_15.getInt(16);
            if(rs_tDBInput_15.wasNull()){
                    laboratory_order_result.archived1 = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_laboratory_order_result";
				...
				laboratory_order_result_HashRow.uuid = laboratory_order_result.uuid;
				
				laboratory_order_result_HashRow.patient_id = laboratory_order_result.patient_id;
				
				laboratory_order_result_HashRow.visit_id = laboratory_order_result.visit_id;
				
				laboratory_order_result_HashRow.order_date = laboratory_order_result.order_date;
				
				laboratory_order_result_HashRow.patient_uuid = laboratory_order_result.patient_uuid;
				
				laboratory_order_result_HashRow.facility_id = laboratory_order_result.facility_id;
				
				laboratory_order_result_HashRow.create_date = laboratory_order_result.create_date;
				
				laboratory_order_result_HashRow.userid = laboratory_order_result.userid;
				...
				laboratory_order_result_HashRow.archived1 = laboratory_order_result.archived1;
 ...
 */
    ...
    public static void main(String[] args){
        final Laboratory_H2 Laboratory_H2Class = new Laboratory_H2();

        int exitCode = Laboratory_H2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Laboratory_H2.class.getClassLoader().getResourceAsStream("lamisplus_etl/laboratory_h2_6_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Laboratory_H2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Laboratory_H2");
        }
...
/************************************************************************************************
 *     653530 characters generated by Talend Open Studio for Big Data 
 *     on the March 11, 2023 5:55:34 AM WAT
 ************************************************************************************************/