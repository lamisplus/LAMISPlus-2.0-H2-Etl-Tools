...
package lamisplus_etl.prep_enrollment_h2_6_0;
...
/**
 * Job: PrEP_Enrollment_H2 Purpose: ETL Tool for PrEP Enrollment migration<br>
 * Description: This ETL tool is used for the migration of PrEP Enrollment data from LAMIS 3 to LAMISPlus prep_enrollment table <br>
 * @author ilozuechukwuemeka@yahoo.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class PrEP_Enrollment_H2 implements TalendJob {
...
public String getLAMISPlus_Database(){
	...
	private final String jobName = "PrEP_Enrollment_H2";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				PrEP_Enrollment_H2.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(PrEP_Enrollment_H2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_LAMISPLUS_ETL_PrEP_Enrollment_H2 = new byte[0];
    static byte[] commonByteArray_LAMISPLUS_ETL_PrEP_Enrollment_H2 = new byte[0];
    ...
    public String loopKey;
			    ...
			    public java.util.Date date_enrolled;

				public java.util.Date getDate_enrolled () {
	...
	public void copyDataTo(out1Struct other) {
		...
		other.id = this.id;
	            ...
	            other.date_enrolled = this.date_enrolled;
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMISPLUS_ETL_PrEP_Enrollment_H2.length) {
				if(length < 1024 && commonByteArray_LAMISPLUS_ETL_PrEP_Enrollment_H2.length == 0) {
   					commonByteArray_LAMISPLUS_ETL_PrEP_Enrollment_H2 = new byte[1024];
				} else {
   					commonByteArray_LAMISPLUS_ETL_PrEP_Enrollment_H2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMISPLUS_ETL_PrEP_Enrollment_H2, 0, length);
			strReturn = new String(commonByteArray_LAMISPLUS_ETL_PrEP_Enrollment_H2, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_PrEP_Enrollment_H2) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.date_enrolled = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.date_enrolled,dos);
    ...
    public String toString() {
		...
		sb.append(",date_enrolled="+String.valueOf(date_enrolled));
	    sb.append("]");
...
int count_tDBOutput_3=0;
	    String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3 + "\" (\"id\",\"unique_id\",\"uuid\",\"date_started\",\"visit_uuid\",\"person_uuid\",\"status\",\"archived\",\"created_by\",\"date_created\",\"modified_by\",\"date_modified\",\"" + "extra" + "\",\"facility_id\",\"target_group\",\"date_enrolled\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?," + "?::json" + ",?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT ps.prepscreening_id AS id, ps.client_unique_id AS unique_id, \nCONCAT('pe',ps.prepscreening_id, '-', n.datim_id,"
+" '-', ps.prepscreening_id, 'pe') AS uuid, \nps.date_prep_initiated AS date_started,\n'' AS visit_uuid, CONCAT(ps.prepscr"
+"eening_id, '-', n.datim_id, '-', ps.prepscreening_id) as person_uuid, \n(CASE WHEN ps.hiv_test_result='HIV Negative' THE"
+"N 'HIV_NEGATIVE'\nWHEN ps.hiv_test_result='HIV Positive' THEN 'HIV_POSITIVE' ELSE NULL END )AS status, \n0 AS archived, "
+"'ETL' AS created_by, ps.time_stamp AS date_created, \n'ETL' AS modified_by, ps.time_stamp AS date_modified,\nn.datim_id,"
+" ps.date_prep_initiated AS date_enrolled, NULL AS target_group,\nNULL AS extra FROM prepscreening ps\nINNER JOIN facilit"
+"y n\n  ON n.facility_id=ps.facility_id";
        	...
        	row2.datim_id = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
							...
							if(colQtyInRs_tDBInput_1 < 14) {
								row2.date_enrolled = null;
							} else {
										
			row2.date_enrolled = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 14);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row2.target_group = null;
							} else {
	                         		
        	row2.target_group = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 16) {
								row2.extra = null;
							} else {
	                         		
        	row2.extra = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, false);
		                    }
...
out1_tmp.date_enrolled = row2.date_enrolled ;
out1 = out1_tmp;
// ###############################
...
pstmt_tDBOutput_3.setNull(15, java.sql.Types.VARCHAR);
                    ...
                    if(out1.date_enrolled != null) {
pstmt_tDBOutput_3.setTimestamp(16, new java.sql.Timestamp(out1.date_enrolled.getTime()));
} else {
 ...
 */
    ...
    public static void main(String[] args){
        final PrEP_Enrollment_H2 PrEP_Enrollment_H2Class = new PrEP_Enrollment_H2();

        int exitCode = PrEP_Enrollment_H2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = PrEP_Enrollment_H2.class.getClassLoader().getResourceAsStream("lamisplus_etl/prep_enrollment_h2_6_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = PrEP_Enrollment_H2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : PrEP_Enrollment_H2");
        }
...
/************************************************************************************************
 *     186888 characters generated by Talend Open Studio for Big Data 
 *     on the April 29, 2023 6:24:51 AM WAT
 ************************************************************************************************/