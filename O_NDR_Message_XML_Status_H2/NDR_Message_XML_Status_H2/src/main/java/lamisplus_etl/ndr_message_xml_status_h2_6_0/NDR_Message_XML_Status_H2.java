...
package lamisplus_etl.ndr_message_xml_status_h2_6_0;
...
/**
 * Job: NDR_Message_XML_Status_H2 Purpose: NDR_Message_Log<br>
 * Description: NDR_Message_Log <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class NDR_Message_XML_Status_H2 implements TalendJob {
...
public String getLAMIS3_H2_Login(){
	...
	private final String jobName = "NDR_Message_XML_Status_H2";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				NDR_Message_XML_Status_H2.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(NDR_Message_XML_Status_H2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Log_OutputStruct implements routines.system.IPersistableRow<Log_OutputStruct> {
    final static byte[] commonByteArrayLock_LAMISPLUS_ETL_NDR_Message_XML_Status_H2 = new byte[0];
    static byte[] commonByteArray_LAMISPLUS_ETL_NDR_Message_XML_Status_H2 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMISPLUS_ETL_NDR_Message_XML_Status_H2.length) {
				if(length < 1024 && commonByteArray_LAMISPLUS_ETL_NDR_Message_XML_Status_H2.length == 0) {
   					commonByteArray_LAMISPLUS_ETL_NDR_Message_XML_Status_H2 = new byte[1024];
				} else {
   					commonByteArray_LAMISPLUS_ETL_NDR_Message_XML_Status_H2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMISPLUS_ETL_NDR_Message_XML_Status_H2, 0, length);
			strReturn = new String(commonByteArray_LAMISPLUS_ETL_NDR_Message_XML_Status_H2, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMISPLUS_ETL_NDR_Message_XML_Status_H2) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT message_id AS id, CONCAT(patient_id, '_', facility_id) AS identifier, \nfile_name AS file, time_stamp AS last_up"
+"dated FROM ndrmessagelog";
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = context.LAMIS3_H2_Password; 
		    ...
		    String dbquery_tDBInput_2 = "SELECT n.message_id AS id, n.file_name, n.time_stamp AS last_updated, nf.datim_id\n  FROM (SELECT *, ROW_NUMBER() OVER "
+"(PARTITION BY file_name ORDER BY time_stamp DESC) \n						  FROM ndrmessagelog)n \nINNER JOIN facility nf ON nf.facility"
+"_id=n.facility_id\n  WHERE n.row_number=1";
        	...
        	row3.file_name = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row3.last_updated = null;
							} else {
										
			row3.last_updated = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 3);
		                    }
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		    ...
                        		    		    row5HashKey.file_name = row3.file_name ;
...
XML_Status_tmp.files = row5.files ;
XML_Status_tmp.last_modified = row3.last_updated ;
...
if(XML_Status != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(XML_Status.id == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(1, XML_Status.id);
}
            ...
            if(checkCount_tDBOutput_2 > 0) {
                        if(XML_Status.files == null) {
pstmtUpdate_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_2.setInt(1, XML_Status.files);
}
...
pstmtUpdate_tDBOutput_2.setNull(2, java.sql.Types.TIMESTAMP);
                        ...
                        if(XML_Status.facility_id == null) {
pstmtUpdate_tDBOutput_2.setNull(3, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_2.setInt(3, XML_Status.facility_id);
}

                        if(XML_Status.id == null) {
pstmtUpdate_tDBOutput_2.setNull(4 + count_tDBOutput_2, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_2.setInt(4 + count_tDBOutput_2, XML_Status.id);
}
...
} else {pstmtInsert_tDBOutput_2.setInt(1, XML_Status.id);
}

                        if(XML_Status.files == null) {
pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_2.setInt(2, XML_Status.files);
}
...
} else {pstmtInsert_tDBOutput_2.setInt(4, XML_Status.facility_id);
}
...
System.out.println("Total latest NDR XML Status records fetched from LAMIS3 - "+globalMap.get("tDBInput_2_NB_LINE"));
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_LAMISPlus";
		...
		int tos_count_tAdvancedHash_LAMISPlus = 0;
			   		...
			   		// linked node: tMap_3 - inputs:(row3,LAMISPlus,row5) outputs:(XML_Status)
...
public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.files = readInteger(dis,ois);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.files, dos, oos);
	...
	currentComponent="tDBInput_5";
		...
		int tos_count_tDBInput_5 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_5 = null;
				...
				String dbUser_tDBInput_5 = context.LAMIS3_H2_Login;
				
				
	final String decryptedPassword_tDBInput_5 = context.LAMIS3_H2_Password; 
				
				String dbPwd_tDBInput_5 = decryptedPassword_tDBInput_5;
				
				String url_tDBInput_5 = "jdbc:postgresql://" + context.LAMIS3_H2_Server + ":" + context.LAMIS3_H2_Port + "/" + context.LAMIS3_H2_Database + "?" + context.LAMIS3_H2_AdditionalParams;
		    ...
		    String dbquery_tDBInput_5 = "SELECT COUNT(file_name) AS files, file_name FROM ndrmessagelog nxs\n  GROUP BY file_name";
            ...
            row5.files = rs_tDBInput_5.getInt(1);
        	...
        	row5.file_name = routines.system.JDBCUtil.getString(rs_tDBInput_5, 2, false);
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final NDR_Message_XML_Status_H2 NDR_Message_XML_Status_H2Class = new NDR_Message_XML_Status_H2();

        int exitCode = NDR_Message_XML_Status_H2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = NDR_Message_XML_Status_H2.class.getClassLoader().getResourceAsStream("lamisplus_etl/ndr_message_xml_status_h2_6_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = NDR_Message_XML_Status_H2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : NDR_Message_XML_Status_H2");
        }
...
/************************************************************************************************
 *     227613 characters generated by Talend Open Studio for Big Data 
 *     on the March 11, 2023 5:57:47 AM WAT
 ************************************************************************************************/